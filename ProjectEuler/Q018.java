...
final class VvyLw extends Utility {
	...
	static final void solve() {
		final var a = new ArrayList<ArrayList<Integer>>();
		for(int i = 0; i < 15; ++i) {
			a.add(new ArrayList<>());
		}
		a.get(0).addAll(Arrays.asList(75));
		a.get(1).addAll(Arrays.asList(95, 64));
		a.get(2).addAll(Arrays.asList(17, 47, 82));
		a.get(3).addAll(Arrays.asList(18, 35, 87, 10));
		a.get(4).addAll(Arrays.asList(20, 04, 82, 47, 65));
		a.get(5).addAll(Arrays.asList(19, 01, 23, 75, 03, 34));
		a.get(6).addAll(Arrays.asList(88, 02, 77, 73, 07, 63, 67));
		a.get(7).addAll(Arrays.asList(99, 65, 04, 28, 06, 16, 70, 92));
		a.get(8).addAll(Arrays.asList(41, 41, 26, 56, 83, 40, 80, 70, 33));
		a.get(9).addAll(Arrays.asList(41, 48, 72, 33, 47, 32, 37, 16, 94, 29));
		a.get(10).addAll(Arrays.asList(53, 71, 44, 65, 25, 43, 91, 52, 97, 51, 14));
		a.get(11).addAll(Arrays.asList(70, 11, 33, 28, 77, 73, 17, 78, 39, 68, 17, 57));
		a.get(12).addAll(Arrays.asList(91, 71, 52, 38, 17, 14, 91, 43, 58, 50, 27, 29, 48));
		a.get(13).addAll(Arrays.asList(63, 66, 04, 68, 89, 53, 67, 30, 73, 16, 69, 87, 40, 31));
		a.get(14).addAll(Arrays.asList(04, 62, 98, 27, 23, 9, 70, 98, 73, 93, 38, 53, 60, 04, 23));
		for(int i = 13; i >= 0; i--) {
			for(int j = 0; j < a.get(i).size(); ++j) {
				a.get(i).set(j, a.get(i).get(j) + max(a.get(i + 1).get(j), a.get(i + 1).get(j + 1)));
			}
		}
		o.out(a.get(0).get(0));
	}
