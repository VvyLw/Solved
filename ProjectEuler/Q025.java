...
final class VvyLw extends Utility {
	...
	static final void solve() {
		final var fib = new ArrayList<BigInteger>(Arrays.asList(BigInteger.ONE, BigInteger.ONE));
		int i = 0;
        // while(fib.getLast().toString().length() < 1000)
        while(fib.get(i + 1).toString().length() < 1000) {
