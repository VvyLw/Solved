...
final class VvyLw extends Utility {
	...
	static final void solve() {
		final var s = "73167176531330624919225119674426574742355349194934"
		...
		for(int i = 0; i < s.length() - d; ++i) {
			final var x = s.substring(i, i + d);
			ans = max(ans, x.chars().mapToLong(Character::getNumericValue).reduce(1L, (a, b) -> a * b));
		}
		o.out(ans);
	}
}
